...
public class StringSQLQueryUtility {
    ...
    private static String getStringToAppendForParameter(String parameter, String paramValue) throws Exception {
        switch (parameter.toUpperCase()) {
            case ONLINE:
                return createStringFromMatchingTrueFalseValues(ONLINE, paramValue, TRUE_VALUES, FALSE_VALUES, EQUALS, NOT_EQUALS, CLASS_TABLE, FORMAT_COLUMN);
            case HYBRID:
                return createStringFromMatchingTrueFalseValues(HYBRID, paramValue, TRUE_VALUES, FALSE_VALUES, EQUALS, NOT_EQUALS, CLASS_TABLE, FORMAT_COLUMN);
            case FACE_TO_FACE_PARAM:
                return createStringFromMatchingTrueFalseValues(FACE_TO_FACE_VALUE, paramValue, TRUE_VALUES, FALSE_VALUES, EQUALS, NOT_EQUALS, CLASS_TABLE, FORMAT_COLUMN);
            case STATUS:
            ...
            case DEPARTMENT:
                return createStringFromColumnConditionValue(CLASS_INFORMATION_TABLE, DEPARTMENT_COLUMN, EQUALS, paramValue);
            case DEPARTMENT_CRN:
                return createStringFromColumnConditionValue(CLASS_INFORMATION_TABLE, DEPARTMENT_CRN_COLUMN, EQUALS, paramValue);
            case LOCATION:
                return createStringFromColumnConditionValue(CLASS_TABLE, LOCATION_COLUMN, EQUALS, paramValue);
            case COMPONENT:
                return createStringFromColumnConditionValue(CLASS_TABLE, COMPONENT_COLUMN, EQUALS, paramValue);
            case BUILDING:
            ...
            case IS_CORE:
                return createStringFromMatchingTrueFalseValues(LIKE_CORE, paramValue, TRUE_VALUES, FALSE_VALUES, LIKE, NOT_LIKE, CLASS_TABLE, ATTRIBUTES_COLUMN);
            case WEEKEND_U:
                return createStringFromMatchingTrueFalseValues(LIKE_WEEKEND_U, paramValue, TRUE_VALUES, FALSE_VALUES, LIKE, NOT_LIKE, CLASS_TABLE, ATTRIBUTES_COLUMN);
            case CORE_ID:
                return createStringMatchLikeEquals(paramValue, CORE_COLUMN);
            case MONDAY:
                return createStringFromMatchingTrueFalseValues("1", paramValue, TRUE_VALUES, FALSE_VALUES, EQUALS, NOT_EQUALS, CLASS_TABLE, MONDAY_COLUMN);
            case TUESDAY:
                return createStringFromMatchingTrueFalseValues("1", paramValue, TRUE_VALUES, FALSE_VALUES, EQUALS, NOT_EQUALS, CLASS_TABLE, TUESDAY_COLUMN);
            case WEDNESDAY:
                return createStringFromMatchingTrueFalseValues("1", paramValue, TRUE_VALUES, FALSE_VALUES, EQUALS, NOT_EQUALS, CLASS_TABLE, WEDNESDAY_COLUMN);
            case THURSDAY:
                return createStringFromMatchingTrueFalseValues("1", paramValue, TRUE_VALUES, FALSE_VALUES, EQUALS, NOT_EQUALS, CLASS_TABLE, THURSDAY_COLUMN);
            case FRIDAY:
                return createStringFromMatchingTrueFalseValues("1", paramValue, TRUE_VALUES, FALSE_VALUES, EQUALS, NOT_EQUALS, CLASS_TABLE, FRIDAY_COLUMN);
            case SATURDAY:
    ...
    private static String createStringFromColumnConditionValue(String tableName, String column, String condition, String paramValue) {
    ...
    private static String getStringForSessionQuery(String column, String condition, String paramValue) throws Exception {
        switch (paramValue.toUpperCase()) {
            case "MIN":
                return createStringFromColumnConditionValue(CLASS_TABLE, column, condition, MINI_SESSION);
            case "1":
                return createStringFromColumnConditionValue(CLASS_TABLE, column, condition, REGULAR_ACADEMIC_SESSION);
            case "2":
            case "3":
            case "4":
            case "5":
            case "6":
                return createStringFromColumnConditionValue(CLASS_TABLE, column, condition, paramValue);
        }
